...
<html lang="en">
  <head>
    ...
    <title>
      Team Page 1 | PLAIN - Multi-Purose Bootstrap HTML5 Template
    </title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            ...
            <div class="quick-contacts pull-left">
              ...
              <span>
                ...
                <a class="__cf_email__" href="../../../cdn-cgi/l/email-protection.htm" data-cfemail="88ede5e9e1e4c8edf0e9e5f8e4eda6ebe7e5">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("data-cfhash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}t.parentNode.removeChild(t);}}catch(u){}}()/* ]]> */</script>
            ...
            <div class="social-links text-center pull-right">
              <a href="team2.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Twitter">
                <i class="fa fa-twitter">
                </i>
              </a>
              <a href="team2.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Facebook">
                <i class="fa fa-facebook">
                </i>
              </a>
              <a href="team2.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Google+">
                <i class="fa fa-google-plus">
                </i>
              </a>
              <a href="team2.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="LinkedIn">
                <i class="fa fa-linkedin">
                </i>
              </a>
              <a href="team2.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="YouTube">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav animated-nav navbar-right">
                  ...
                  <li class="dropdown dropdown-toggle active">
                    <a href="team2.html#" data-toggle="dropdown">
                      Pages
                    </a>
                  ...
                  <li class="search">
                    <a href="team2.html#" class="open-search">
                ...
                <form class="full-search">
                  <div class="container">
                    ...
                    <a href="team2.html#" class="close-search">
    ...
    <div class="page-header">
      <div class="page-header-inner">
        <div class="container">
          ...
          <ol class="breadcrumb">
            <li><a href="team2.html#">Home</a></li>
            <li class="page">Team Page 2</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <section id="team-block-2">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="0.0s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img1.jpg" alt="member-1">
              ...
              <div class="member-info">
                ...
                <div class="social-team">
                  <a href="team2.html#" class="social">
                    <i class="fa fa-twitter">
                    </i>
                  </a>
                  <a href="team2.html#" class="social">
                  ...
                  <a class="social" href="team2.html#">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="0.3s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img2.jpg" alt="member-1">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="0.6s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img3.jpg" alt="member-1">
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="0.9s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img4.jpg" alt="member-1">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="1.1s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img5.jpg" alt="member-1">                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUpQuick" data-wow-delay="1.3s">
            <div class="team-member">
              <div class="face">
                <img src="assets/img/team/img6.jpg" alt="member-1">
        ...
        <div class="row">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".2s">
            ...
            <ul class="recent-tweets">
              <li class="tweet">
                My <a href="team2.html#">@Quora</a>                
                <span class="tweet-text">
                  answer to What's the best FAQ plugin for WordPress?
                </span>
                <a href="team2.html#">qr.ae/RFTbIGa</a> 
              ...
              <li class="tweet">
                WPB Advanced FAQ | Probably The Best WordPress FAQ Plugin <a href="team2.html#">wpbean.com/wpb-advanced-faq-pr…</a>               
                <span class="tweet-text">
                  via
                </span>
                <a href="team2.html#">@wpbean</a> 
                <span class="tweet-date">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="team2.html#" title="Pan Masala"><img src="assets/img/flicker/img1.jpg" alt=""></a>
              <a href="team2.html#" title="Sports Template for Joomla"><img src="assets/img/flicker/img2.jpg" alt=""></a>
              <a href="team2.html" title="Apple Keyboard"><img src="assets/img/flicker/img3.jpg" alt=""></a>
              <a href="team2.html" title="Hard Working"><img src="assets/img/flicker/img4.jpg" alt=""></a>
              <a href="team2.html" title="Smile"><img src="assets/img/flicker/img5.jpg" alt=""></a>
              <a href="team2.html" title="Puzzle"><img src="assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".8s">
            ...
            <div class="tagcloud">
              <a href="team2.html#" class="tag-link-201" title="1 topic"><i class="fa fa-tags"></i> Audio Post</a>
              <a href="team2.html#" class="tag-link-197" title="1 topic"><i class="fa fa-tags"></i> Gallery Post</a>
              <a href="team2.html#" class="tag-link-195" title="1 topic"><i class="fa fa-tags"></i> Image Post</a>
              <a href="team2.html#" class="tag-link-211" title="1 topic"><i class="fa fa-tags"></i> life style</a>
              <a href="team2.html#" class="tag-link-204" title="1 topic"><i class="fa fa-tags"></i> Link Post</a>
              <a href="team2.html#" class="tag-link-203" title="1 topic"><i class="fa fa-tags"></i> Quote Post</a>
              <a href="team2.html#" class="tag-link-199" title="1 topic"><i class="fa fa-tags"></i> Video Post</a>
            </div>
          </div><!-- Footer Widget Ends -->
        </div><!-- Row Ends -->
      </div><!-- Container Ends -->
