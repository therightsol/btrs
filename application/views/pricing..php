...
<html lang="en">
  <head>
    ...
    <title>
     Pricing Tables | PLAIN - Multi-Purose Bootstrap HTML5 Template
    </title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            ...
            <div class="quick-contacts pull-left">
              ...
              <span>
                ...
                <a class="__cf_email__" href="../../../cdn-cgi/l/email-protection.htm" data-cfemail="77121a161e1b37120f161a071b125914181a">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("data-cfhash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}t.parentNode.removeChild(t);}}catch(u){}}()/* ]]> */</script>
            ...
            <div class="social-links text-center pull-right">
              <a href="pricing.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Twitter">
                <i class="fa fa-twitter">
                </i>
              </a>
              <a href="pricing.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Facebook">
                <i class="fa fa-facebook">
                </i>
              </a>
              <a href="pricing.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Google+">
                <i class="fa fa-google-plus">
                </i>
              </a>
              <a href="pricing.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="LinkedIn">
                <i class="fa fa-linkedin">
                </i>
              </a>
              <a href="pricing.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="YouTube">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav animated-nav navbar-right">
                  ...
                  <li class="dropdown dropdown-toggle active">
                    <a href="pricing.html#" data-toggle="dropdown">
                      Pages
                    </a>
                  ...
                  <li class="search">
                    <a href="pricing.html#" class="open-search">
                ...
                <form class="full-search">
                  <div class="container">
                    ...
                    <a href="pricing.html#" class="close-search">
      ...
      <div class="page-header-inner">
        <div class="container">
          ...
          <ol class="breadcrumb">
            ...
            <li class="page">Pricing Tables</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 wow fadeInUpQuick" data-wow-delay=".5s">
            <div class="pricing-table pricing-table-1 text-center">
              ...
              <div class="plan-info">
                ...
                <div class="button-area">
                  <a href="pricing.html#" class="btn btn-common btn-lg">
                    Give a Try
                  </a>
                </div>
              </div>
    ...
    <section id="pricing-block-2">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 wow fadeInUpQuick" data-wow-delay=".5s">
            <div class="pricing-table pricing-table-2 text-center">
              <div class="head">
                <h3 class="period">
                  Weekly
                </h3>
              ...
              <a href="pricing.html#" class="btn btn-border btn-lg">
                Sign Up
              </a>
            </div>
          </div>
          
          <div class="col-md-3 wow fadeInUpQuick" data-wow-delay="1s">
            <div class="pricing-table pricing-table-2 text-center">
              <div class="head">
                <h3 class="period">
                  Monthly
          ...
          <div class="col-md-3 wow fadeInUpQuick" data-wow-delay="1.5s">
            <div class="pricing-table pricing-table-2 text-center">
              <div class="head">
                <h3 class="period">
                  Quarterly
          ...
          <div class="col-md-3 wow fadeInUpQuick" data-wow-delay="2s">
            <div class="pricing-table pricing-table-2 text-center">
              <div class="head">
                <h3 class="period">
                  Yerly
        ...
        <div class="row">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".2s">
            ...
            <ul class="recent-tweets">
              <li class="tweet">
                My <a href="pricing.html#">@Quora</a>                
                <span class="tweet-text">
                  answer to What's the best FAQ plugin for WordPress?
                </span>
                <a href="pricing.html#">qr.ae/RFTbIGa</a> 
              ...
              <li class="tweet">
                WPB Advanced FAQ | Probably The Best WordPress FAQ Plugin <a href="pricing.html#">wpbean.com/wpb-advanced-faq-pr…</a>               
                <span class="tweet-text">
                  via
                </span>
                <a href="pricing.html#">@wpbean</a> 
                <span class="tweet-date">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="pricing.html#" title="Pan Masala"><img src="assets/img/flicker/img1.jpg" alt=""></a>
              <a href="pricing.html#" title="Sports Template for Joomla"><img src="assets/img/flicker/img2.jpg" alt=""></a>
              <a href="pricing.html" title="Apple Keyboard"><img src="assets/img/flicker/img3.jpg" alt=""></a>
              <a href="pricing.html" title="Hard Working"><img src="assets/img/flicker/img4.jpg" alt=""></a>
              <a href="pricing.html" title="Smile"><img src="assets/img/flicker/img5.jpg" alt=""></a>
              <a href="pricing.html" title="Puzzle"><img src="assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".8s">
            ...
            <div class="tagcloud">
              <a href="pricing.html#" class="tag-link-201" title="1 topic"><i class="fa fa-tags"></i> Audio Post</a>
              <a href="pricing.html#" class="tag-link-197" title="1 topic"><i class="fa fa-tags"></i> Gallery Post</a>
              <a href="pricing.html#" class="tag-link-195" title="1 topic"><i class="fa fa-tags"></i> Image Post</a>
              <a href="pricing.html#" class="tag-link-211" title="1 topic"><i class="fa fa-tags"></i> life style</a>
              <a href="pricing.html#" class="tag-link-204" title="1 topic"><i class="fa fa-tags"></i> Link Post</a>
              <a href="pricing.html#" class="tag-link-203" title="1 topic"><i class="fa fa-tags"></i> Quote Post</a>
              <a href="pricing.html#" class="tag-link-199" title="1 topic"><i class="fa fa-tags"></i> Video Post</a>
            </div>
          </div><!-- Footer Widget Ends -->
        </div><!-- Row Ends -->
      </div><!-- Container Ends -->
