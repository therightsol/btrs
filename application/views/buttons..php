...
<html lang="en">
  <head>
    ...
    <title>
      Buttons | PLAIN - Multi-Purose Bootstrap HTML5 Template
    </title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            ...
            <div class="quick-contacts pull-left">
              ...
              <span>
                ...
                <a class="__cf_email__" href="../../../cdn-cgi/l/email-protection.htm" data-cfemail="cda8a0aca4a18da8b5aca0bda1a8e3aea2a0">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("data-cfhash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}t.parentNode.removeChild(t);}}catch(u){}}()/* ]]> */</script>
            ...
            <div class="social-links text-center pull-right">
              <a href="buttons.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Twitter">
                <i class="fa fa-twitter">
                </i>
              </a>
              <a href="buttons.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Facebook">
                <i class="fa fa-facebook">
                </i>
              </a>
              <a href="buttons.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Google+">
                <i class="fa fa-google-plus">
                </i>
              </a>
              <a href="buttons.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="LinkedIn">
                <i class="fa fa-linkedin">
                </i>
              </a>
              <a href="buttons.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="YouTube">
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav animated-nav navbar-right">
                  ...
                  <li class="search">
                    <a href="buttons.html#" class="open-search">
                ...
                <form class="full-search">
                  <div class="container">
                    ...
                    <a href="buttons.html#" class="close-search">
          ...
          <div class="col-md-12">
            <div class="buttons">
              <div class="medium-spacer">
                ...
                <a href="buttons.html#" class="btn btn-common btn-sm">
                  Common
                </a>
                <a href="buttons.html#" class="btn btn-border btn-sm">
                  Border
                </a>
                <a href="buttons.html#" class="btn btn-gray btn-sm">
                  Gray
                </a>
                <a href="buttons.html#" class="btn btn-dark btn-sm">
                  Dark
                </a>
                <a href="buttons.html#" class="btn btn-default btn-sm">
                  Default
                </a>
                <a href="buttons.html#" class="btn btn-primary btn-sm">
                  Primary
                </a>
                <a href="buttons.html#" class="btn btn-success btn-sm">
                  success
                </a>
                <div class="small-spacer">
                </div>
                <a href="buttons.html#" class="btn btn-info btn-sm">
                  info
                </a>
                <a href="buttons.html#" class="btn btn-warning btn-sm">
                  warning
                </a>
                <a href="buttons.html#" class="btn btn-danger btn-sm">
                  danger
                </a>
                ...
                <a href="buttons.html#" class="btn btn-common">
                  Common
                </a>
                <a href="buttons.html#" class="btn btn-border">
                  Border
                </a>
                <a href="buttons.html#" class="btn btn-gray">
                  Gray
                </a>
                <a href="buttons.html#" class="btn btn-dark">
                  Dark
                </a>
                <a href="buttons.html#" class="btn btn-default">
                  Default
                </a>
                <div class="small-spacer">
                </div>
                <a href="buttons.html#" class="btn btn-primary">
                  Primary
                </a>
                <a href="buttons.html#" class="btn btn-success">
                  success
                </a>
                <a href="buttons.html#" class="btn btn-info">
                  info
                </a>
                <a href="buttons.html#" class="btn btn-warning">
                  warning
                </a>
                <a href="buttons.html#" class="btn btn-danger">
                  danger
                </a>
                <h3>
                  Large
                </h3>
                <a href="buttons.html#" class="btn btn-common btn-lg">
                  Common
                </a>
                <a href="buttons.html#" class="btn btn-border btn-lg">
                  Border
                </a>
                <a href="buttons.html#" class="btn btn-gray btn-lg">
                  Gray
                </a>
                <a href="buttons.html#" class="btn btn-dark btn-lg">
                  Dark
                </a>
                <a href="buttons.html#" class="btn btn-default btn-lg">
                  Default
                </a>
                <a href="buttons.html#" class="btn btn-primary btn-lg">
                  Primary
                </a>
                <a href="buttons.html#" class="btn btn-success btn-lg">
                  success
                </a>
                <div class="small-spacer">
                </div>
                <a href="buttons.html#" class="btn btn-info btn-lg">
                  info
                </a>
                <a href="buttons.html#" class="btn btn-warning btn-lg">
                  warning
                </a>
                <a href="buttons.html#" class="btn btn-danger btn-lg">
                  danger
                </a>
              </div>
              ...
              <div class="medium-spacer">
                ...
                <a href="buttons.html#" class="btn btn-common btn-sm">
                  <i class="fa fa-chevron-left pr-10">
                  </i>
                  Prev
                </a>
                <a href="buttons.html#" class="btn btn-border btn-sm">
                  Next
                  <i class="fa fa-chevron-right pl-10">
                  </i>
                </a>
                <a href="buttons.html#" class="btn btn-gray btn-sm">
                  Send 
                  <i class="fa fa-check pl-10">
                  </i>
                </a>
                <a href="buttons.html#" class="btn btn-dark btn-sm">
                  <i class="fa fa-lock pr-10">
                  </i>
                  Login
                </a>
                <a href="buttons.html#" class="btn btn-default btn-sm">
                ...
                <a href="buttons.html#" class="btn btn-info btn-sm">
                  Print 
                  <i class="fa fa-print pl-10">
                  </i>
                </a>
                <a href="buttons.html#" class="btn btn-warning btn-sm">
                  Open 
                  <i class="fa fa-folder-open-o pl-10">
                  </i>
                </a>
                <a href="buttons.html#" class="btn btn-danger btn-sm">
                  Denger 
                  <i class="fa fa-warning pl-10">
                  </i>
                </a>
                <h3>
                  Medium
        ...
        <div class="row">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".2s">
            ...
            <ul class="recent-tweets">
              <li class="tweet">
                My <a href="buttons.html#">@Quora</a>                
                <span class="tweet-text">
                  answer to What's the best FAQ plugin for WordPress?
                </span>
                <a href="buttons.html#">qr.ae/RFTbIGa</a> 
              ...
              <li class="tweet">
                WPB Advanced FAQ | Probably The Best WordPress FAQ Plugin <a href="buttons.html#">wpbean.com/wpb-advanced-faq-pr…</a>               
                <span class="tweet-text">
                  via
                </span>
                <a href="buttons.html#">@wpbean</a> 
                <span class="tweet-date">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="buttons.html#" title="Pan Masala"><img src="assets/img/flicker/img1.jpg" alt=""></a>
              <a href="buttons.html#" title="Sports Template for Joomla"><img src="assets/img/flicker/img2.jpg" alt=""></a>
              <a href="buttons.html" title="Apple Keyboard"><img src="assets/img/flicker/img3.jpg" alt=""></a>
              <a href="buttons.html" title="Hard Working"><img src="assets/img/flicker/img4.jpg" alt=""></a>
              <a href="buttons.html" title="Smile"><img src="assets/img/flicker/img5.jpg" alt=""></a>
              <a href="buttons.html" title="Puzzle"><img src="assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".8s">
            ...
            <div class="tagcloud">
              <a href="buttons.html#" class="tag-link-201" title="1 topic"><i class="fa fa-tags"></i> Audio Post</a>
              <a href="buttons.html#" class="tag-link-197" title="1 topic"><i class="fa fa-tags"></i> Gallery Post</a>
              <a href="buttons.html#" class="tag-link-195" title="1 topic"><i class="fa fa-tags"></i> Image Post</a>
              <a href="buttons.html#" class="tag-link-211" title="1 topic"><i class="fa fa-tags"></i> life style</a>
              <a href="buttons.html#" class="tag-link-204" title="1 topic"><i class="fa fa-tags"></i> Link Post</a>
              <a href="buttons.html#" class="tag-link-203" title="1 topic"><i class="fa fa-tags"></i> Quote Post</a>
              <a href="buttons.html#" class="tag-link-199" title="1 topic"><i class="fa fa-tags"></i> Video Post</a>
            </div>
          </div><!-- Footer Widget Ends -->
        </div><!-- Row Ends -->
      </div><!-- Container Ends -->
