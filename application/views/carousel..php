...
<html lang="en">
  <head>
    ...
    <title>
      Carousel Slider - MultiPurose HTML5 Template
    </title>
    <!-- Bootstrap -->
      ...
      <div class="container">
          ...
          <div class="quick-contacts pull-left">
            ...
            <span>
              ...
              <a class="__cf_email__" href="../../../cdn-cgi/l/email-protection.htm" data-cfemail="640109050d0824011c05091408014a070b09">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("data-cfhash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}t.parentNode.removeChild(t);}}catch(u){}}()/* ]]> */</script>
          ...
          <div class="social-links text-center pull-right">
            <a href="carousel.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Twitter">
              <i class="fa fa-twitter">
              </i>
            </a>
            <a href="carousel.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Facebook">
              <i class="fa fa-facebook">
              </i>
            </a>
            <a href="carousel.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Google+">
              <i class="fa fa-google-plus">
              </i>
            </a>
            <a href="carousel.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="LinkedIn">
              <i class="fa fa-linkedin">
              </i>
            </a>
            <a href="carousel.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="YouTube">
            ...
            <div class="collapse navbar-collapse" id="navbar">
              <ul class="nav navbar-nav animated-nav navbar-right">
                ...
                <li class="dropdown dropdown-toggle">
                  <a href="carousel.html#" data-toggle="dropdown">
                    Pages
                  </a>
                ...
                <li class="search">
                  <a href="carousel.html#" class="open-search">
              ...
              <form class="full-search">
                <div class="container">
                  ...
                  <a href="carousel.html#" class="close-search">
    ...
    <div class="page-header-inner">
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="page">Carousel Slider</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">          
        <div class="col-sm-6 col-md-6">
          ...
          <div class="custom-carousel">              
            ...
            <div id="carousel-about-us" class="owl-carousel" role="listbox">
              ...
              <div class="item">
                <img src="assets/img/about/img3.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/about/img4.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/about/img5.jpg" alt="...">
              </div>                  
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-6">
          ...
          <div class="text-carousel">              
            <!-- Wrapper for slides -->
            <div id="carousel-text" class="owl-carousel" role="listbox">
              <div class="item active">
                <div class="text-carousel">
                  <img class="alignleft" src="assets/img/about/about3.png" alt="">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker .
                </div>
              </div>                  
              <div class="item">
                <div class="text-carousel">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="custom-carousel">              
            <!-- Wrapper for slides -->
            <div id="carousel-full" class="owl-carousel" role="listbox">
              <div class="item active">
                <img src="assets/img/blog/blog-slider/img1.jpg" alt="...">
              </div>                  
              <div class="item">
                <img src="assets/img/blog/blog-slider/img2.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/blog/blog-slider/img3.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/blog/blog-slider/img4.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/blog/blog-slider/img5.jpg" alt="...">
              </div>
              <div class="item">
                <img src="assets/img/blog/blog-slider/img6.jpg" alt="...">
              </div>                   
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".2s">
            ...
            <ul class="recent-tweets">
              <li class="tweet">
                My <a href="carousel.html#">@Quora</a>                
                <span class="tweet-text">
                  answer to What's the best FAQ plugin for WordPress?
                </span>
                <a href="carousel.html#">qr.ae/RFTbIGa</a> 
              ...
              <li class="tweet">
                WPB Advanced FAQ | Probably The Best WordPress FAQ Plugin <a href="carousel.html#">wpbean.com/wpb-advanced-faq-pr…</a>               
                <span class="tweet-text">
                  via
                </span>
                <a href="carousel.html#">@wpbean</a> 
                <span class="tweet-date">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="carousel.html#" title="Pan Masala"><img src="assets/img/flicker/img1.jpg" alt=""></a>
              <a href="carousel.html#" title="Sports Template for Joomla"><img src="assets/img/flicker/img2.jpg" alt=""></a>
              <a href="carousel.html" title="Apple Keyboard"><img src="assets/img/flicker/img3.jpg" alt=""></a>
              <a href="carousel.html" title="Hard Working"><img src="assets/img/flicker/img4.jpg" alt=""></a>
              <a href="carousel.html" title="Smile"><img src="assets/img/flicker/img5.jpg" alt=""></a>
              <a href="carousel.html" title="Puzzle"><img src="assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".8s">
            ...
            <div class="tagcloud">
              <a href="carousel.html#" class="tag-link-201" title="1 topic"><i class="fa fa-tags"></i> Audio Post</a>
              <a href="carousel.html#" class="tag-link-197" title="1 topic"><i class="fa fa-tags"></i> Gallery Post</a>
              <a href="carousel.html#" class="tag-link-195" title="1 topic"><i class="fa fa-tags"></i> Image Post</a>
              <a href="carousel.html#" class="tag-link-211" title="1 topic"><i class="fa fa-tags"></i> life style</a>
              <a href="carousel.html#" class="tag-link-204" title="1 topic"><i class="fa fa-tags"></i> Link Post</a>
              <a href="carousel.html#" class="tag-link-203" title="1 topic"><i class="fa fa-tags"></i> Quote Post</a>
              <a href="carousel.html#" class="tag-link-199" title="1 topic"><i class="fa fa-tags"></i> Video Post</a>
            </div>
          </div><!-- Footer Widget Ends -->
        </div><!-- Row Ends -->
      </div><!-- Container Ends -->
