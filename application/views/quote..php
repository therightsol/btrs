...
<html lang="en">
  <head>
    ...
    <title>
     Plain Quote Post Format | PLAIN - Multi-Purose Bootstrap HTML5 Template
    </title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            ...
            <div class="quick-contacts pull-left">
              ...
              <span>
                ...
                <a class="__cf_email__" href="../../../cdn-cgi/l/email-protection.htm" data-cfemail="6f0a020e06032f0a170e021f030a410c0002">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">
/* <![CDATA[ */!function(){try{var t="currentScript"in document?document.currentScript:function(){for(var t=document.getElementsByTagName("script"),e=t.length;e--;)if(t[e].getAttribute("data-cfhash"))return t[e]}();if(t&&t.previousSibling){var e,r,n,i,c=t.previousSibling,a=c.getAttribute("data-cfemail");if(a){for(e="",r=parseInt(a.substr(0,2),16),n=2;a.length-n;n+=2)i=parseInt(a.substr(n,2),16)^r,e+=String.fromCharCode(i);e=document.createTextNode(e),c.parentNode.replaceChild(e,c)}t.parentNode.removeChild(t);}}catch(u){}}()/* ]]> */</script>
            ...
            <div class="social-links text-center pull-right">
              <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Twitter">
                <i class="fa fa-twitter">
                </i>
              </a>
              <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Facebook">
                <i class="fa fa-facebook">
                </i>
              </a>
              <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="Google+">
                <i class="fa fa-google-plus">
                </i>
              </a>
              <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="LinkedIn">
                <i class="fa fa-linkedin">
                </i>
              </a>
              <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="YouTube">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav animated-nav navbar-right">
                  ...
                  <li class="dropdown dropdown-toggle">
                    <a href="quote.html#" data-toggle="dropdown">
                      Pages
                    </a>
                  ...
                  <li class="search">
                    <a href="quote.html#" class="open-search">
                ...
                <form class="full-search">
                  <div class="container">
                    ...
                    <a href="quote.html#" class="close-search">
          ...
          <div class="col-md-8">
            <div class="post">
              <header class="entry-header">
                <h1 class="blog-title entry-title">Plain Quote Post Format</h1>
              </header>
              <div class="post-content">
                <div class="date">
                  ...
                  <span class="post-type pull-right">
                    <a href="quote.html#"><i class="fa fa-quote-left"></i></a>
                  </span>
                </div>
                <blockquote>
                ...
                <div class="reading clearfix">
                  <ul class="social-icons-fill light pull-right">   
                    <li>
                    <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Twitter">
                      <i class="fa fa-twitter">
                      </i>
                    </a>
                  </li>
                  <li>
                    <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Facebook">
                      <i class="fa fa-facebook">
                      </i>
                    </a>
                  </li>
                  <li>
                    <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Google+">
                      <i class="fa fa-google-plus">
                      </i>
                    </a>
                  </li>
                  <li>
                    <a href="quote.html#" class="social-link" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="LinkedIn">
                      <i class="fa fa-linkedin">
                      </i>
                    </a>
                  </li>
            ...
            <div class="author">
              ...
              <div class="author-comment">
                ...
                <a class="author-link btn btn-common" href="quote.html#" rel="author">View all posts by Imran</a>
              </div>
              <div class="clear">
              </div>
            </div>
            ...
            <nav class="navigation">
              <div class="nav-links">
                <div class="nav-previous">
                  <a href="quote.html#">Plain Gallery Post Format</a>
                </div>
                <div class="nav-next">
                  <a href="quote.html#">Plain Standard Post</a>
                </div>
              </div>
            </nav>
            ...
            <div class="respond">
              ...
              <form action="quote.html" class="form-horizontal">
          ...
          <div class="col-md-4">
            <div class="sidebar">
              <div class="search-box">
                <form action="quote.html" method="get">
                  <fieldset>
              ...
              <div class="popular-post widget">
                ...
                <ul>
                  <li><a href="quote.html#">Starting a Business Guide</a></li>
                  <li><a href="quote.html#">Plan for what is difficult</a></li>
                  <li><a href="quote.html#">Colorful Easter Eggs</a></li>
                  <li><a href="quote.html#">Plain Standard Post</a></li>
                  <li><a href="quote.html#">Plain Image Post Format</a></li>
                </ul>
              </div>
              ...
              <div class="popular-post widget">
                ...
                <ul>
                  <li><a href="quote.html#">April 2015</a></li>
                  <li><a href="quote.html#">March 2015</a></li>
                </ul>
              </div>
              ...
              <div class="meta widget">
                ...
                <ul>
                  <li><a href="quote.html#">Log In</a></li>
                  <li><a href="quote.html#">Entries RSS</a></li>
                  <li><a href="quote.html#">Comments RSS</a></li>
                  <li><a href="quote.html#">WordPress.Org</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".2s">
            ...
            <ul class="recent-tweets">
              <li class="tweet">
                My <a href="quote.html#">@Quora</a>                
                <span class="tweet-text">
                  answer to What's the best FAQ plugin for WordPress?
                </span>
                <a href="quote.html#">qr.ae/RFTbIGa</a> 
                <span class="tweet-date">
                  August 21, 2015 10:29pm
                </span>
              </li>              
              <li class="tweet">
                WPB Advanced FAQ | Probably The Best WordPress FAQ Plugin <a href="quote.html#">wpbean.com/wpb-advanced-faq-pr…</a>               
                <span class="tweet-text">
                  via
                </span>
                <a href="quote.html#">@wpbean</a> 
                <span class="tweet-date">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="quote.html#" title="Pan Masala"><img src="assets/img/flicker/img1.jpg" alt=""></a>
              <a href="quote.html#" title="Sports Template for Joomla"><img src="assets/img/flicker/img2.jpg" alt=""></a>
              <a href="quote.html" title="Apple Keyboard"><img src="assets/img/flicker/img3.jpg" alt=""></a>
              <a href="quote.html" title="Hard Working"><img src="assets/img/flicker/img4.jpg" alt=""></a>
              <a href="quote.html" title="Smile"><img src="assets/img/flicker/img5.jpg" alt=""></a>
              <a href="quote.html" title="Puzzle"><img src="assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".8s">
            ...
            <div class="tagcloud">
              <a href="quote.html#" class="tag-link-201" title="1 topic"><i class="fa fa-tags"></i> Audio Post</a>
              <a href="quote.html#" class="tag-link-197" title="1 topic"><i class="fa fa-tags"></i> Gallery Post</a>
              <a href="quote.html#" class="tag-link-195" title="1 topic"><i class="fa fa-tags"></i> Image Post</a>
              <a href="quote.html#" class="tag-link-211" title="1 topic"><i class="fa fa-tags"></i> life style</a>
              <a href="quote.html#" class="tag-link-204" title="1 topic"><i class="fa fa-tags"></i> Link Post</a>
              <a href="quote.html#" class="tag-link-203" title="1 topic"><i class="fa fa-tags"></i> Quote Post</a>
              <a href="quote.html#" class="tag-link-199" title="1 topic"><i class="fa fa-tags"></i> Video Post</a>
            </div>
          </div><!-- Footer Widget Ends -->
        </div><!-- Row Ends -->
      </div><!-- Container Ends -->
